...
{
#if defined(STM32F072xB) || defined(STM32L073xx)
    IrqPriorities priority = IRQ_HIGH_PRIORITY;
#elif defined(STM32F401xC)
    IrqPriorities priority = IRQ_MEDIUM_PRIORITY;
#endif
    GpioSetInterrupt( &SX1276.DIO0, IRQ_RISING_EDGE, priority, irqHandlers[0] );
    GpioSetInterrupt( &SX1276.DIO1, IRQ_RISING_EDGE, priority, irqHandlers[1] );
    GpioSetInterrupt( &SX1276.DIO2, IRQ_RISING_EDGE, priority, irqHandlers[2] );
    GpioSetInterrupt( &SX1276.DIO3, IRQ_RISING_EDGE, priority, irqHandlers[3] );
    GpioSetInterrupt( &SX1276.DIO4, IRQ_RISING_EDGE, priority, irqHandlers[4] );
    GpioSetInterrupt( &SX1276.DIO5, IRQ_RISING_EDGE, priority, irqHandlers[5] );
}
